...
`GeneratedMobs` (`internal static partial class`). `generate-mobs` enumerates every effective block
in pinned `db/re/mob_db.yml`; runtime compatibility never filters source-data generation. Output is
sharded on a fixed 1000-MobId grid (1000-1999, 2000-2999, ..., including sparse modern ranges),
never item-count chunks, and empty buckets produce no file. The current pin produces 2,675
definitions in six shards plus `GeneratedMobs.Registry.cs`.

```text
Generated/GameData/Mobs/GeneratedMobs.Monsters.1000-1999.cs
Generated/GameData/Mobs/GeneratedMobs.Monsters.2000-2999.cs
Generated/GameData/Mobs/GeneratedMobs.Monsters.3000-3999.cs
Generated/GameData/Mobs/GeneratedMobs.Monsters.20000-20999.cs
Generated/GameData/Mobs/GeneratedMobs.Monsters.21000-21999.cs
Generated/GameData/Mobs/GeneratedMobs.Monsters.22000-22999.cs
Generated/GameData/Mobs/GeneratedMobs.Registry.cs
```
...
`GeneratedMobRegistry` is a generated dictionary-backed `MobId -> MobDefinition` index with
`TryGet`/`Get`, exact IDs, count, and values. Named fields remain useful for known content, while
generic runtime/data consumers do not need a curated switch. Aegis names are split on punctuation,
converted to PascalCase, prefixed with `Mob` if they begin with a digit, protected from C# keywords,
and deterministically suffixed with `_<MobId>` on normalized collisions.

One invocation regenerates the complete set. Cleanup is restricted to files with the owned
`GeneratedMobs.Monsters.*.cs`/`GeneratedMobs.Registry.cs` names and the generator header; unrelated
...
Keep three independent claims explicit: (1) source representation is 2,675/2,675, (2) generated
production data is 2,675/2,675 with exact ID-set equality, and (3) runtime capability remains
partial for drops, skills, race groups, MVP behavior, and unimplemented mode semantics. A generated
definition does not imply that those gameplay systems exist. Mob-spawn dependency is
`MobSpawn.MobId -> GeneratedMobRegistry -> MobDefinition`; declaration/map validity and effective
gameplay runtime readiness remain separate results.
