...
public sealed class MapTelemetry : IDisposable
{
    ...
    public static readonly Counter<long> ConnectionsAccepted =
        Meter.CreateCounter<long>(
            "map.connections.accepted");

    public static readonly Histogram<double> WorldCommandDuration =
        Meter.CreateHistogram<double>(
            "world.command.duration",
            "ms");

    public static readonly Counter<long> WorldCommandFailures =
        Meter.CreateCounter<long>(
            "world.command.failures");
