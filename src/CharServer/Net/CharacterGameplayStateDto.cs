...
internal sealed record CharacterGameplayStateDto(uint CharacterId, ulong Version, ushort BaseLevel, ushort JobLevel,
...
{
    internal static CharacterGameplayStateDto From(CharCharacter value) => new(value.CharId, value.GameplayStateVersion,
