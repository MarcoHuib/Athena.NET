...
namespace Athena.Net.CharServer.Telemetry;

public sealed class CharTelemetry : IDisposable
{
    private const string ServiceName = "char-server";

    public static readonly ActivitySource ActivitySource = new(ServiceName);
    public static readonly Meter Meter = new(ServiceName);
    public static readonly Counter<long> ConnectionsAccepted = Meter.CreateCounter<long>("char.connections.accepted");

    private readonly TracerProvider _tracerProvider;
    private readonly MeterProvider _meterProvider;
    private readonly ILoggerFactory _loggerFactory;

    private CharTelemetry(TracerProvider tracerProvider, MeterProvider meterProvider, ILoggerFactory loggerFactory)
    {
    ...
    public static CharTelemetry Start()
    {
        ...
        Meter.CreateObservableGauge("char.uptime.seconds", () => (DateTimeOffset.UtcNow - startTime).TotalSeconds);
        ...
        return new CharTelemetry(tracerProvider, meterProvider, loggerFactory);
    }
    ...
    public void Dispose()
    {
        Logging.CharLogger.SetTelemetrySink(null);
