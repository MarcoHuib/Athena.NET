...
public sealed class MapCharacterGameplayStateProtocolTests
{
    ...
    {
        var expected=new CharacterGameplayStateDto(9,4,0,1,1,0,0,40,11,40,11,48,0,1,1,1,1,1,1);
        ...
        MapCharacterGameplayStateProtocol.Write(packet.AsSpan(76,MapCharacterGameplayStateProtocol.StateLength),updated);
